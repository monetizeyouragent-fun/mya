...
const ENTRIES = [
  ...
  { name: "OpenAI GPT Store", category: "Earn Now", subcategory: "Sell Skills & Services", url: "https://chat.openai.com/gpts", description: "3M+ custom GPTs. No official rev-share yet, but creators use external Stripe paywalls. Massive reach.", stage: "Live", model: "External paywalls", traction: "3M+ GPTs created", earn_potential: "$0–$50K/mo", difficulty: "Easy", time_to_first_dollar: "Varies", votes_up: 89, votes_down: 0 },
  ...
  { name: "Relevance AI", category: "Earn Now", subcategory: "Build & Sell Agents", url: "https://relevanceai.com", description: "Build teams of AI agents without code, sell them as services to businesses. 40K agents created in Jan 2025.", stage: "Live", model: "SaaS platform", traction: "$24M Series B", earn_potential: "$1K–$50K/mo", difficulty: "Medium", time_to_first_dollar: "1–4 weeks", votes_up: 62, votes_down: 0 },
  ...
  { name: "AgentHotspot", category: "Platforms", subcategory: "MCP Marketplaces", url: "#", description: "Search, integrate, monetize MCP connectors. 6,000+ curated connectors.", stage: "Live", model: "MCP marketplace", traction: "6,000+ connectors", votes_up: 42, votes_down: 0 },
  ...
  { name: "AIXBT", category: "Token Agents", subcategory: "Tokenized Ownership", url: "#", description: "AI market analysis agent, tokenized. Automated intelligence and trading signals.", stage: "Live", model: "Token", traction: "", earn_potential: "Variable", difficulty: "Easy (buy token)", time_to_first_dollar: "Instant", votes_up: 41, votes_down: 0 },
];
