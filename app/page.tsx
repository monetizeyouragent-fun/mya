...
export default async function Home() {
  ...
  const pyrimidPlatform: Entry = {
    ...
    url: 'https://pyrimid.ai',
    description: 'Agent-to-agent commerce network. MCP server exposes the full catalog as tools — agents browse, buy, and earn commissions programmatically. 100+ products from multiple vendors.',
    stage: 'Live',
  ...
  const pragmaEarn: Entry = {
    ...
    traction: 'Live signal engine, 204+ signals logged',
