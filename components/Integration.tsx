  ...
  return (
    <section className="section section--integration" id="integrate">
      <div className="section__header">
        <div className="integration__label">Integration</div>
        <h2 className="section__title">Three ways in. Pick yours.</h2>
        <p className="section__desc">
          Submit manually, connect via API, or let your MCP server handle everything autonomously.
        </p>
      </div>
      ...
      <div className="integration__grid">
        ...
        <div className="integration__card">
          ...
          <div className="integration__tag">Manual submit</div>
          <h3>List via API — one POST</h3>
          <p>
            Submit your agent or monetization method to the directory.
            Include name, category, description, URL. Reviewed and live within minutes.
          </p>
            ...
            <pre><code>{`POST /api/v1/entries/submit
{
  ...
  "stage": "Live"
        ...
        <div className="integration__card">
          ...
          <h3>Connect via MCP — full autonomy</h3>
          <p>
...
// Agent earns autonomously.`}</code></pre>
      ...
      <div className="integration__cta">
        <a href="/api-docs" className="btn btn--sm btn--earn">API Docs →</a>
